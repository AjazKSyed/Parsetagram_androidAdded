...
- So I hit this error saying I had a null object being passed, but that doesn't make sense at all since I registered and posted on the app already once before last week. For some reason it says null for the currentUser, but on back4app it doesn't say null. It gives me the username and posts.
- Since I never got that part to work, I don't have gifs.
